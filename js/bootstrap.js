...
+function ($) {
    ...
    $(document).on('click.bs.modal.data-api', '[data-toggle="modal"]', function (e) {
        ...
        userdata['surname'] = getCookie('surname');
        userdata['phone'] = getCookie('phone');
        userdata['myData'] = getCookie('myData');
        if (userdata['username'])$('#inputName').val(userdata['username']);
        if (userdata['surname'])$('#inputSurname').val(userdata['surname']);
        if (userdata['phone']) {
